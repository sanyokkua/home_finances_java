...
VALUES ((SELECT "u_id" FROM "app_finance"."user_auth" WHERE "app_finance"."user_auth"."u_email" = 'user1@gmail.com'),
        'user1');

INSERT INTO "app_finance"."user" ("u_id", "u_nickname")
VALUES ((SELECT "u_id" FROM "app_finance"."user_auth" WHERE "app_finance"."user_auth"."u_email" = 'user2@gmail.com'),
        'user2');

INSERT INTO "app_finance"."user" ("u_id", "u_nickname")
VALUES ((SELECT "u_id" FROM "app_finance"."user_auth" WHERE "app_finance"."user_auth"."u_email" = 'user3@gmail.com'),
        'user3');

INSERT INTO "app_finance"."user" ("u_id", "u_nickname")
VALUES ((SELECT "u_id" FROM "app_finance"."user_auth" WHERE "app_finance"."user_auth"."u_email" = 'user4@gmail.com'),
        'user4');

INSERT INTO "app_finance"."user" ("u_id", "u_nickname")
VALUES ((SELECT "u_id" FROM "app_finance"."user_auth" WHERE "app_finance"."user_auth"."u_email" = 'user5@gmail.com'),
        'user5');

INSERT INTO "app_finance"."user" ("u_id", "u_nickname")
VALUES ((SELECT "u_id" FROM "app_finance"."user_auth" WHERE "app_finance"."user_auth"."u_email" = 'user6@gmail.com'),
        'user6');
