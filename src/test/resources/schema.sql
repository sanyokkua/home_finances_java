...
ALTER TABLE
    "app_finance"."user"
    ADD
        FOREIGN KEY ("u_id") REFERENCES "app_finance"."user_auth" ("u_id")
            ON DELETE CASCADE;
ALTER TABLE
    "app_finance"."list"
    ADD
        FOREIGN KEY ("l_u_id") REFERENCES "app_finance"."user" ("u_id")
            ON DELETE CASCADE;
ALTER TABLE
    "app_finance"."purchase"
    ADD
        FOREIGN KEY ("p_l_id") REFERENCES "app_finance"."list" ("l_id")
            ON DELETE CASCADE;
