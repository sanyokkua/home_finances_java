...
public class PostgresqlCrudPurchaseApiRepository implements CrudPurchaseApi {
    ...
    public boolean createPurchase(Purchase purchase) {
        ...
        // @formatter:off
        val params = Map.of("listId",   purchase.getPurchaseListId(),
    ...
    public boolean updatePurchase(Purchase purchase) {
        ...
        // @formatter:off
        val params = Map.of("id", purchase.getPurchaseId(),
                            "listId",   purchase.getPurchaseListId(),
                            "name",     purchase.getName(),
                            "coins",    purchase.getCoins(),
                            "currency", purchase.getCurrency().name(),
                            "date",     purchase.getDate(),
    ...
    public boolean deletePurchase(long purchaseListId, long purchaseId) {
        ...
        // @formatter:off
        val params = Map.of("id",       purchaseId,
                            "listId",   purchaseListId);
        // @formatter:on
        val sql = """
                DELETE FROM "app_finance"."purchase" WHERE "p_id" = :id AND "p_l_id" = :listId
                """;
    ...
    public Optional<Purchase> getPurchase(long purchaseListId, long purchaseId) {
        ...
        // @formatter:on
        val sql = """
                SELECT * FROM "app_finance"."purchase" WHERE "p_id" = :id AND "p_l_id" = :listId
                """;
